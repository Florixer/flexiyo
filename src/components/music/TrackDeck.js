  ...
  return (
    <div className="track-deck">
      <div className="track-deck--cover">
        <img src="https://c.saavncdn.com/252/Laapataa-Ladies-Hindi-2024-20240213151004-500x500.jpg" />
      </div>
      <div className="track-deck--details">
        <label className="track-deck--details-name">
          {currentTrack.name}Sajni Re
        </label>
        <label className="track-deck--details-artists">
          {currentTrack.artists}Ram Sampath, Arijit Singh, Prashant Pandey
        </label>
      </div>
        <div
          // ref={progressBarRef}
